...
date: 2020-12-17 16:23:10
permalink: /pages/78a148/
categories:
  - 《TypeScript》教程
  - 手册指南
tags: 
...
你可以在这里找到所有`JSDoc`支持的模式，[JSDoc文档](https://github.com/Microsoft/TypeScript/wiki/JSDoc-support-in-JavaScript)。
...
对JavaScript文件里模块语法的支持比在`TypeScript`里宽泛多了。 大部分的赋值和声明方式都是允许的。
...
可以使用`TypeScript`或Closure语法指定函数类型。
