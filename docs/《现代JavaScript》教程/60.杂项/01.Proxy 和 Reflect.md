...
date: 2020-12-13 22:32:07
permalink: /pages/d81db5/
categories:
  - 《现代JavaScript》教程
  - 杂项
tags: 
...
![](https://picgoi-mg.oss-cn-beijing.aliyuncs.com/img/20201213223303.png)
...
> **类的私有属性**
>
> 现代 `JavaScript` 引擎原生支持 `class` 中的私有属性，这些私有属性以 `#` 为前缀。它们在私有的和受保护的属性和方法一章中有详细描述。无需代理（`proxy`）。
>
